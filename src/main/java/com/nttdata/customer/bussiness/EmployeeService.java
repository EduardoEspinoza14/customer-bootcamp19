...
public interface EmployeeService {
    ...
    //PARA OBTENER UN SOLO EMPLEADO POR SU ID Y ID DE CLIENTE (COMPANY), PARA VERIFICAR QUE EL EMPLEADO CONSULTADO PERTENECE AL CLIENTE
    ...
    //PARA ACTUALIZAR UN EMPLEADO DE UN CLIENTE TIPO EMPRESA, REFERENCIADO POR EL ID DEL CLIENTE E ID DEL EMPLEADO
